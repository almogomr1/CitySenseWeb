...
const CitizenMessageSidebarLeft: React.FC<AuthorityMessageSidebarLeftProps> = ({
    chats,
    setSelectedContact,
    setSelectedUser,
    contactUsers,
    ...
    const handleChatClick = async (contactId: string, contact: Contact) => {
        ...
        setSelectedUser({ authority: contact });
        setActive(contactId);
    ...
    const renderChats = () => {
        ...
        return chats.map((item) => {
            ...
            const name = item?.authority?.fullname;
            return (
                <li
                    key={item._id}
...
export default CitizenMessageSidebarLeft;
